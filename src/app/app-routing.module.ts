...
const isAdmin = (next: any) => map( (user: any) => !!user && 'aGbcYC0X9xfi9i6bEMNMJitwTK03' === user.uid);
...
const routes: Routes = [
  ...
  {
    path: 'platillo/:id',
    loadChildren: () => import('./platillo/platillo.module').then( m => m.PlatilloPageModule)
  },
